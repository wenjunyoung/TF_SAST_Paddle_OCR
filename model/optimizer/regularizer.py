...
class tf_L1Decay(object):
    ...
    def __call__(self):
        reg = tf.keras.regularizers.L1(self.regularization_coeff)
        return reg
...
class tf_L2Decay(object):
    ...
    def __init__(self, factor=0.0):
        super(tf_L2Decay, self).__init__()
        self.regularization_coeff = factor

    def __call__(self):
        reg = tf.keras.regularizers.L2(self.regularization_coeff)
        return reg        
